      ...
      >
        ...
        <div className="p-4">
          <button
            ...
            className="w-full flex items-center px-4 py-3 text-red-200 hover:text-white hover:bg-red-600/50 rounded-lg transition-all duration-200"
          >
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              >
                <div className="relative">
                  <i className={`bx ${unreadCount > 0 ? 'bx-bell bx-tada' : 'bx-bell'} text-2xl`}></i>
                  {unreadCount > 0 && (
                    <>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2 sm:space-x-3 flex-1 min-w-0">
                        ...
                        <div className="min-w-0 flex-1">
                          <h3 className="text-base sm:text-lg font-bold text-black truncate">Notifications</h3>
                          <p className="text-black/80 text-xs sm:text-sm truncate">{unreadCount} unread</p>
                        </div>
                      </div>
                  ...
                  <div className="max-h-96 overflow-y-auto bg-gray-700">
                    {notifLoading ? (
                      <div className="p-8 text-center">
                        ...
                        <p className="text-sm text-gray-300 mt-3 font-medium">Loading notifications...</p>
                      </div>
                      ...
                      notifications.map((notification, index) => (
                        <motion.div
                          ...
                          className={`p-3 sm:p-4 border-b border-gray-600/50 hover:bg-gray-600 transition-all duration-200 ${
                            !notification.is_read ? 'bg-yellow-500/20 border-l-4 border-l-yellow-500' : 'bg-gray-700'
                          }`}
                        >
                          <div className="flex items-start space-x-2 sm:space-x-4">
                            <div className={`p-1.5 sm:p-2 rounded-lg flex-shrink-0 ${
                              !notification.is_read ? 'bg-yellow-500' : 'bg-gray-600'
                            }`}>
                              <i className={`bx ${getNotifIcon(notification.message)} text-sm sm:text-lg ${
                                !notification.is_read ? 'text-black' : 'text-yellow-400'
                              }`}></i>
                            </div>
