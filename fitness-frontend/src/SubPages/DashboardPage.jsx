...
const [shopRevenue, setShopRevenue] = useState(0);
  ...
  try {
    ...
    // Fetch purchases
    const purchasesResponse = await axios.get('http://127.0.0.1:8000/api/purchases/', {
      headers: { 'Authorization': `Bearer ${token}` }
    });
    ...
    } else if (purchasesResponse.data.results && Array.isArray(purchasesResponse.data.results)) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow transform hover:-translate-y-1 duration-200">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-sm font-medium text-gray-400 uppercase tracking-wider mb-1">Member Revenue</p>
              {loading ? (
