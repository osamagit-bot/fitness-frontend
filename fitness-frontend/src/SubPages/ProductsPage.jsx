...
function ProductsPage() {
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      const response = await axios.get('fitness-frontend-0ri3.onrender.com/api/products/', {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('fitness-frontend-0ri3.onrender.com/api/products/', formData, {
        headers: {
  ...
  const deleteProduct = async (productId) => {
    if (window.confirm('Are you sure you want to delete this product?')) {
      try {
        const token = localStorage.getItem('token');
        await axios.delete(`fitness-frontend-0ri3.onrender.com/api/products/${productId}/`, {
          headers: { 'Authorization': `Bearer ${token}` }
        });
