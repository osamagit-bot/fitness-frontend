...
function MemberProfilePage() {
  ...
  const handleUpdateSubmit = async (e) => {
    ...
    if (!member) {
      alert("Cannot update: Member data not loaded");
      return;
    }
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      if (err.response && err.response.data) {
        alert(`Failed to change password: ${JSON.stringify(err.response.data)}`);
      } else {
  ...
  return (
    ...
    >
      ...
      {/* Profile Header */}
      <motion.div
        className="bg-gray-900 text-white p-6 rounded-lg mb-6"
        initial={{ opacity: 0, y: -30 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.15 }}
      >
        <div className="flex flex-col sm:flex-row items-center sm:items-start">
          <div className="bg-yellow-500 rounded-full w-24 h-24 flex items-center justify-center text-4xl font-bold mb-4 sm:mb-0 sm:mr-6">
            {member.first_name ? member.first_name[0].toUpperCase() : 'M'}
          </div>
          <div>
            <h2 className="text-2xl font-bold">{member.first_name} {member.last_name}</h2>
            <p className="text-yellow-500">{member.membership_type}</p>
            <div className="mt-2">
        ...
        <div className="space-y-4">
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="font-semibold">MEM-{member.athlete_id}</p>
            </div>
          </div>
          <div className="flex items-start">
            <div className="bg-yellow-100 p-2 rounded mr-4">
            ...
            <div>
              ...
              <p className="font-semibold">{member.username || 'Not set'}</p>
            </div>
          </div>
          <div className="flex items-start">
            <div className="bg-yellow-100 p-2 rounded mr-4">
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="font-semibold">{member.start_date || 'Not available'}</p>
            </div>
          </div>
          <div className="flex items-start">
            <div className="bg-yellow-100 p-2 rounded mr-4">
            ...
            <div>
              ...
              <p className="font-semibold">{member.monthly_fee ? `${member.monthly_fee} AFN` : '0.00 AFN'}</p>
            </div>
          </div>
        </div>
