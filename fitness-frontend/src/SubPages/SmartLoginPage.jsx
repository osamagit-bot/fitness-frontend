  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex items-center justify-center relative overflow-hidden">
      ...
      >
        ...
        <span className="lg:text-md font-medium hidden sm:inline">Back to Home</span>
      </Link>
      ...
      <div className={`relative z-10 max-w-md w-full mx-4 transition-all duration-700 ${
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 shadow-2xl p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              } ${loading ? 'opacity-50 cursor-not-allowed' : 'hover:shadow-lg transform hover:scale-[1.02]'} focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900`}
            >
              {loading ? (
