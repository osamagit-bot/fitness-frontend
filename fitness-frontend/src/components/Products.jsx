            ...
            <div className="lg:w-1/2 p-4 md:p-6">
              ...
              <div className="mt-6">
                ...
                <button
                  ...
                  className="mt-6 w-full bg-yellow-500 hover:bg-yellow-600 text-gray-800 py-3 px-4 rounded-md transition duration-300 flex items-center justify-center"
                >
            ...
            {filteredProducts.map((product, i) => (
              ...
              >
                ...
                <button 
                  ...
                  className="w-full bg-yellow-500 hover:bg-yellow-600 text-gray-800 py-2 md:py-2.5 rounded-md transition duration-300 flex items-center justify-center text-sm md:text-base"
                >
