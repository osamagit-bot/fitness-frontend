    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('biometric_templates', models.JSONField(blank=True, default=list, help_text='Stores multiple biometric templates for comparison')),
                ('biometric_quality_threshold', models.FloatField(default=0.8, help_text='Minimum quality score for biometric matching')),
                ('last_biometric_update', models.DateTimeField(blank=True, null=True)),
